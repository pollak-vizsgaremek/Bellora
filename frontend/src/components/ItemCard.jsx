  ...
  return (
    ...
    >
      ...
      <div className="p-3 md:p-4">
        <h3 className="font-semibold text-base md:text-lg mb-1 md:mb-2 text-white truncate">
          {item.title}
        </h3>
        <p className="text-blue-400 font-bold text-lg md:text-xl mb-1 md:mb-2">
          {item.price.toLocaleString()} Ft
        </p>
        <p className="text-gray-400 text-xs md:text-sm">
          Eladó: {item.seller_name}
        </p>
