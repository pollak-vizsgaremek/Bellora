...
import { Package, Plus, Edit, Trash2, CheckCircle, Clock, DollarSign, Box } from 'lucide-react';
                ...
                <div className="container mx-auto px-4">
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                        <div>
                            ...
                            <p className="text-sm md:text-base text-blue-100">Kezeld és kövesd nyomon a hirdetéseidet</p>
                        </div>
                        <button
            ...
            <div className="container mx-auto px-4 -mt-6 md:-mt-8 mb-6 md:mb-8">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4">
                    <div className="bg-gray-800/60 backdrop-blur-lg border border-gray-700 rounded-xl p-4 md:p-6 text-center">
                        <div className="text-2xl md:text-4xl font-bold text-white mb-1 md:mb-2">{stats.total}</div>
                    ...
                    <div className="bg-green-900/40 backdrop-blur-lg border border-green-700 rounded-xl p-4 md:p-6 text-center">
                        <div className="text-2xl md:text-4xl font-bold text-green-400 mb-1 md:mb-2">{stats.available}</div>
                    ...
                    <div className="bg-red-900/40 backdrop-blur-lg border border-red-700 rounded-xl p-4 md:p-6 text-center">
                        <div className="text-2xl md:text-4xl font-bold text-red-400 mb-1 md:mb-2">{stats.sold}</div>
                    ...
                    <div className="bg-yellow-900/40 backdrop-blur-lg border border-yellow-700 rounded-xl p-4 md:p-6 text-center">
                        <div className="text-2xl md:text-4xl font-bold text-yellow-400 mb-1 md:mb-2">{stats.reserved}</div>
            ...
            <div className="container mx-auto px-4 pb-12">
                {loading ? (
                    ...
                    <div className="text-center py-12 md:py-20 bg-gray-800/60 backdrop-blur-lg rounded-2xl border border-gray-700 px-4">
                        ...
                        <h3 className="text-xl md:text-2xl font-bold text-white mb-2">Még nincs hirdetésed</h3>
                        <p className="text-sm md:text-base text-gray-400 mb-4 md:mb-6">Kezdj el eladásba és add fel az első hirdetésedet!</p>
                        <button
                            onClick={() => navigate('/new-item')}
                            ...
                            >
                                <div className="relative">
                                    ...
                                    <div className="absolute top-3 right-3">
                                        <span className={`px-3 py-1 rounded-full text-xs font-bold ${item.status === 'available' ? 'bg-green-500 text-white' :
                                                item.status === 'sold' ? 'bg-red-500 text-white' :
                                                    'bg-yellow-500 text-black'
                                            }`}>
                                            {item.status === 'available' ? '✓ Elérhető' :
                                ...
                                <div className="p-3 md:p-4">
                                    ...
                                    <div className="flex gap-2">
                                        ...
                                        >
                                            <Edit className="w-3 h-3 md:w-3.5 md:h-3.5" /> <span className="hidden sm:inline">Szerkesztés</span><span className="sm:hidden">Szerk.</span>
                                        </button>
                                        <button
